...
export function LaboratorioQuimica({onClose}){
    return(
    <Modal animationType="slide" transparent={true} visible={true}>
        <View style={style.centeredView}>
            <View style={style.modalView}>
                <Text style={style.modalText}>Laboratorio de Quimica</Text>

                <ScrollView style={style.scroll}>
                        {/* Carrusel de img */}
                    <CarruselImg
                        imagenes={[
                            require("../../../../assets/Img/Laboratorios/Lab_quimica/Lab_Quimica.jpg"),
                            require("../../../../assets/Img/Laboratorios/Lab_quimica/Lab_Quimica2.jpg"),
                            require("../../../../assets/Img/Laboratorios/Lab_quimica/Lab_Quimica3.jpg"),
                        ]}
                    />
