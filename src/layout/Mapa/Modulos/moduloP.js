...
export function ModuloP({onClose}){
    return(
    <Modal animationType="slide" transparent={true} visible={true}>
        <View style={style.centeredView}>
            <View style={style.modalView}>
                <Text style={style.modalText}>Modulo P</Text>

                <ScrollView style={style.scroll}>
                        {/* Carrusel de img */}
                    <CarruselImg 
                        imagenes={[
                            require("../../../../assets/Img/Modulos/ModuloP/modulop.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloP/modulop2.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloP/modulop3.jpg"),
                        ]}
                    />
