...
export function ModuloQ({onClose}){
    return(
    <Modal animationType="slide" transparent={true} visible={true}>
        <View style= {style.centeredView}>
            <View style={style.modalView}>
                <Text style={style.modalText}>Modulo Q</Text>

                <ScrollView style={style.scroll}>
                            {/* Carrusel de img */}
                    <CarruselImg
                        imagenes={[
                            require("../../../../assets/Img/Modulos/ModuloQ/moduloq.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloQ/moduloq2.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloQ/moduloq3.jpg"),
                        ]}
                    />
                        {/*Texto descriptivo del modulo */}
                    <CardDescripcion>
                        El Modulo Q es un edificio que alberga aulas.
                    </CardDescripcion>
                        {/* Boton */}
