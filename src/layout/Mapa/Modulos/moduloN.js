...
export function ModuloN({onClose}){
    return(
    <Modal animationType="slide" transparent={true} visible={true}>
        <View style= {style.centeredView}>
            <View style={style.modalView}>
                <Text style={style.modalText}>Modulo N y M</Text>

                <ScrollView style={style.scroll}>
                            {/* Carrusel de img */}
                    <CarruselImg
                        imagenes={[
                            require("../../../../assets/Img/Modulos/ModuloN/modulon1.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloN/modulon2.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloN/modulon3.jpg"),
                        ]}
                    />
                        {/*Texto descriptivo del modulo */}
                    <CardDescripcion>
                        El Modulo N y M son dos modulos que estan uno a lado del otro y estan unidos por un puente.
                    </CardDescripcion>
                        {/* Boton */}
