...
export function ModuloT({onClose}){
    return(
    <Modal animationType="slide" transparent={true} visible={true}>
        <View style= {style.centeredView}>
            <View style={style.modalView}>
                <Text style={style.modalText}>Modulo T</Text>

                <ScrollView style={style.scroll}>
                            {/* Carrusel de img */}
                    <CarruselImg
                        imagenes={[
                            require("../../../../assets/Img/Modulos/ModuloT/moduloT.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloT/moduloT2.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloT/moduloT3.jpg"),
                        ]}
                    />
                        {/*Texto descriptivo del modulo */}
                    <CardDescripcion>
                        El Modulo T es un modulo donde se imparte gran variedad de materias.
                    </CardDescripcion>
                        {/* Boton */}
