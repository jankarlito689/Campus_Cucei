...
export function ModuloF({onClose}){
    return(
    <Modal animationType="slide" transparent={true} visible={true}>
        <View style= {style.centeredView}>
            <View style={style.modalView}>
                <Text style={style.modalText}>Modulo F</Text>

                <ScrollView style={style.scroll}>
                            {/* Carrusel de img */}
                    <CarruselImg
                        imagenes={[
                            require("../../../../assets/Img/Modulos/ModuloF/modulof.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloF/modulof2.jpg"),
                            require("../../../../assets/Img/Modulos/ModuloF/modulof3.jpg"),
                        ]}
                    />
                        {/*Texto descriptivo del modulo */}
                    <CardDescripcion>
                        El Modulo F es una extenxion de los modulos de quimica la mayoria de sus salones se encuentran en el segundo piso.
                    </CardDescripcion>
                        {/* Boton */}
